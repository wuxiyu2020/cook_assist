#ifndef __TG710x_FW_API_H__
#define __TG710x_FW_API_H__
...
void tg710x_fw_xtal_capcode_set(uint8_t cap_in, uint8_t cap_out, uint8_t enable, uint8_t cap_in_max, uint8_t cap_out_max);
void tg710x_fw_xtal_capcode_update(uint8_t cap_in, uint8_t cap_out);
void tg710x_fw_xtal_capcode_restore(void);
void tg710x_fw_xtal_capcode_autofit(void);
void tg710x_fw_xtal_capcode_get(uint8_t *cap_in, uint8_t *cap_out);
//void tg710x_fw_rf_tx_power_table_set(bl_tx_pwr_tbl_t* pwr_table);
int tg710x_fw_password_hash(char *password, char *ssid, int ssidlength, char *output);
void tg710x_fw_rf_table_set(uint32_t* channel_div_table_in, uint16_t* channel_cnt_table_in,
                                                uint16_t lo_fcal_div);

void tg710x_fw_dump_data(void);
void tg710x_fw_dump_statistic(int forced);

int tg710x_check_mac_status(int *is_ok);
...
int tg710x_edca_get(int ac, uint8_t *aifs, uint8_t *cwmin, uint8_t *cwmax, uint16_t *txop);
...
void bl_tpc_update_power_limit(int8_t channel, int8_t en, uint8_t limit[4]);
