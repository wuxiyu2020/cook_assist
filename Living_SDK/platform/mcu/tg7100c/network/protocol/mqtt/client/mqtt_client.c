...
int iotx_mc_handle_reconnect(iotx_mc_client_t *pClient)
{
    ...
    dump_device_state(STATE_CODE_MQTT_RECONNECT, "start reconnect mqtt");
#endif
...
#ifdef CONFIG_WIRELESS_LOG
        dump_device_state(STATE_CODE_MQTT_RECONNECT_SUCCESS, "reconnect mqtt success");
#endif
        return SUCCESS_RETURN;
    } else {
...
#ifdef CONFIG_WIRELESS_LOG
    dump_device_state(STATE_CODE_MQTT_RECONNECT_FAIL, "reconnect mqtt fail:%d", rc);
#endif
