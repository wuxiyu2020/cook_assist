...
#define configMAX_PRIORITIES /*32*/0
...
#define CONFIG_BT_RX_STACK_SIZE  (4096 + 512)//1536//1024
#else
#define CONFIG_BT_RX_STACK_SIZE  (4096 + 512)//1536//1024
#endif
#endif
...
#define CONFIG_BT_RX_PRIO (/*configMAX_PRIORITIES - 4*/configMAX_PRIORITIES+3)
#endif
/**
...
#define CONFIG_BT_HCI_TX_STACK_SIZE (2048)//2048//1024//200
#endif
...
#define CONFIG_BT_HCI_TX_PRIO (/*configMAX_PRIORITIES - 3*/configMAX_PRIORITIES+2)
#endif

#ifndef CONFIG_BT_CTLR_RX_PRIO
#define CONFIG_BT_CTLR_RX_PRIO (/*configMAX_PRIORITIES - 4*/configMAX_PRIORITIES+3)
#endif
...
#define CONFIG_BT_DEVICE_NAME "TG"
#endif
...
#define CONFIG_BT_CONTROLLER_NAME "TG7100C-BLE-DEV"
#else
...
#define CONFIG_BT_WORK_QUEUE_STACK_SIZE  (2048)//3072//1536//1280//512 
#endif
