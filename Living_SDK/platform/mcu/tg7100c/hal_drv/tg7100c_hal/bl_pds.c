...
void ATTR_TCM_SECTION bl_pds_init(void)
{
    ...
    XIP_SFlash_Read_Via_Cache_Need_Lock(TG7100C_FLASH_XIP_BASE+FLASH_CFG_OFFSET,(uint8_t *)(&flashCfg),sizeof(SPI_Flash_Cfg_Type));
    XIP_SFlash_Read_Via_Cache_Need_Lock(TG7100C_FLASH_XIP_BASE+XTAL_TYPE_OFFSET,&xtalType,1);
    SFlash_Cache_Flush();
    __enable_irq();
