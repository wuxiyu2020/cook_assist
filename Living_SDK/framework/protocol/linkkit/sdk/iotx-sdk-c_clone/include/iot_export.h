...
#define LIVING_SDK_VERSION  "1.6.6-19"
...
DECLARE_EVENT_CALLBACK(ITE_SUB_ERRCODE_MQTT_COMM,  state_handler_t cb);
...
DECLARE_EVENT_CALLBACK(ITE_STATE_DEV_STATE,  state_handler_t cb);
...
#define dump_mqtt_status(...)            iotx_state_event(ITE_SUB_ERRCODE_MQTT_COMM, __VA_ARGS__)
...
#define dump_device_state(...)           iotx_state_event(ITE_STATE_DEV_STATE, __VA_ARGS__)
