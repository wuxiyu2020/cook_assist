...
typedef enum{
    HAL_WIFI_COEXMODE_NONE,                    /* wifi combo chip none coexistence mode */
    HAL_WIFI_COEXMODE_WIFI_ONLY,               /* wifi combo chip only wifi mode, ble mesh force closed */
    HAL_WIFI_COEXMODE_BLE_ONLY,                /* wifi combo chip only ble&mesh mode, wifi force closed */
    HAL_WIFI_COEXMODE_WIFI_MESH,               /* wifi combo chip ble-mesh & wifi RF coexistence */
    HAL_WIFI_COEXMODE_MAX
} HAL_Wifi_CoexMode_t;
