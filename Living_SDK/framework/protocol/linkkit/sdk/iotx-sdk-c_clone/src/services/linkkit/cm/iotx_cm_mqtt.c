...
#define BASE_INTERVAL_TIME_MS (1000)
    ...
    do {
        ...
        if (rc ==  0) {
            ...
            dump_device_state(STATE_CODE_MQTT_CONNECT, "start connect mqtt");
#endif
            ...
            {
#ifdef CONFIG_WIRELESS_LOG
                dump_device_state(STATE_CODE_MQTT_CONNECT_SUCCESS, "connect mqtt success");
#endif
...
#ifdef CONFIG_WIRELESS_LOG
    dump_device_state(STATE_CODE_MQTT_CONNECT_FAIL, "connect mqtt fail:%d", rc);
#endif
