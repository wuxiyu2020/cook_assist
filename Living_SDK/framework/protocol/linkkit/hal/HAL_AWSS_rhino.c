...
int HAL_Wifi_Coex_Mode_Set(HAL_Wifi_CoexMode_t mode)
{
    return hal_wifi_coex_mode_set((hal_wifi_coexmode_t)mode);
}

int HAL_Wifi_Coex_Params_Set(HAL_Wifi_CoexMode_t mode, int param)
{
    return hal_wifi_coex_param_set((hal_wifi_coexmode_t)mode, param, 0);
}
