...
$(NAME)_SOURCES := vendor.c \
                   mars_template_main.c \
                   app_entry.c

# $(NAME)_SOURCES += $(wildcard mars_driver/*.c)
...
$(NAME)_SOURCES += mars_driver/mars_cloud.c\
                   ...
                   mars_driver/mars_uartmsg.c \
                   mars_driver/mars_ota.c \
                   mars_driver/mars_i2c.c \
                   mars_driver/mars_network.c

$(NAME)_SOURCES += mars_devfunc/mars_stove.c \
                   mars_devfunc/mars_steamoven.c \
                   mars_devfunc/mars_devmgr.c \
                   mars_devfunc/mars_ca.c \
                   mars_devfunc/mars_display.c \
                   mars_devfunc/mars_factory.c  \
                   mars_devfunc/cook_assistant/buildin_signals.c \
                   mars_devfunc/cook_assistant/ca_signals_lib.c \
                   mars_devfunc/cook_assistant/ca_signals_api.c \
                   mars_devfunc/cook_assistant/app_pot_cover/pot_cover_signals.c \
                   mars_devfunc/cook_assistant/app_pot_cover/pot_cover.c \
                   mars_devfunc/cook_assistant/app_water_boil/water_boil_signals.c \
                   mars_devfunc/cook_assistant/app_water_boil/water_boil.c \
                   mars_devfunc/cook_assistant/app_quick_cooking/quick_cooking.c \
                   mars_devfunc/cook_assistant/app_quick_cooking/soft_boil_egg.c \
                   mars_devfunc/cook_assistant/app_quick_cooking/blanching.c \
                   mars_devfunc/cook_assistant/app_quick_cooking/boil_dumplings.c \
                   mars_devfunc/cook_assistant/ca_apps.c \
...
$(NAME)_SOURCES += common/combo_net.c
CONFIG_COMBOAPP := 1
CONFIG_AWSS_MODE = AWSS_BT_MODE
endif
...
$(NAME)_PREBUILT_LIBRARY := mars_devfunc/irt102m/Lib_Irt102mDataCalibra.a
...
# GLOBAL_CFLAGS += -DDEV_MODEL=\"$(CONFIG_DEV_MODEL)\"
