 ...
 * @LastEditors  : zhouxc
 * @LastEditTime : 2024-11-11 18:05:49
...
int change_multivalve_gear(unsigned char gear, enum INPUT_DIR input_dir)
{
    ...
    if(gear > 7 || gear < 0)
    {
        LOG_default("multivalve not support this gear\r\n");
        return -1;
    }
