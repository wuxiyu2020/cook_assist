...
#define log_module_name "blanching"
...
#define BIG_TO_SMALL_AT_LEAST_INTERVAL_TICKS    (30 * 4)  // 大火要调到小火，大火至少需要持续的时间  et70小火太小了，大火持续久点原本是10
// #define SMALL_TO_BIG_AT_LEAST_INTERVAL_TICKS    (20 * 4)  // 小火要调到大火，小火至少需要持续的时间
#define BIG_TO_SMALL_AT_MOST_INTERVAL_TICKS    (30 * 4)  // 大火要调到小火，大火至多能持续的时间
...
static int access_judge()
{
    ...
    if (g_cook_model != NULL && g_cook_model->cook_type != BLANCHING) return 1;
